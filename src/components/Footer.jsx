            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="overflow-x-hidden lg:col-span-1">
                ...
                <div className="flex min-w-0">
                  ...
                  />
                  <button className="bg-orange-500 cursor-pointer hover:bg-orange-600 text-white px-3 lg:px-4 py-2 rounded-r-lg transition-colors duration-200 text-sm font-medium whitespace-nowrap flex-shrink-0">
                    Subscribe
                  </button>
                </div>
              </div>
